      ...
      <div className='flex gap-10 justify-center flex-wrap'>
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-3 rounded-2xl md:w-780'>
              <div className='flex justify-between'>
                <p className='font-seminbold text-xl'>Revenue Section</p>
                ...
                <div className='border-r-1 border-color m-4 pr-10'>
                  ...
                  <div>
                    <p>
                      ...
                      <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full bg-green-400 text-white m-3 text-xs'>
                        23%
                      </span>
                    </p>
