  ...
  return (
    <div className="relative flex justify-between p-2 md:mx-6">
      ...
      <TooltipComponent content="Profile" position="BottomCenter">
        <div className="flex items-center gap-2 rounded-lg cursor-pointer hover:bg-light-gray p-1"
        onClick={() => handleClick('userProfile')}
        >
           <img className="rounded-full h-8 w-8" src={avatar} alt="avatar" />
            <p>
              <span className="text-gray-400 text-14">Hi,</span>{' '}
              <span className="text-gray-400 text-14 ml-1 font-bold">Abhishek</span>
            </p>
